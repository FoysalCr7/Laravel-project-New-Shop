        ...
        <ul class="nav" id="side-menu">
            ...
            <li>
                ...
                <ul class="nav nav-second-level">
                    ...
                    <li>
                        <a href="{{ route('/category/manege') }}">Manage Category</a>
                    </li>
                </ul>
            <li>
                ...
                <ul class="nav nav-second-level">
                    ...
                    <li>
                        <a href="{{ route('/brand/manege') }}">Manage Brand</a>
                    </li>
                </ul>
                <!-- /.nav-second-level -->
            </li>
            <li>
                ...
                <ul class="nav nav-second-level">
                    ...
                    <li>
                        <a href="{{ route('/product/manege') }}">Manage Product</a>
                    </li>
                </ul>
                <!-- /.nav-second-level -->
            </li>
            ...
            <li>
                <a href="{{ route('/manege/order') }}"><i class="fa fa-table fa-fw"></i> Manege Order</a>
            </li>
            <li>
